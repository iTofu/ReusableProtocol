...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A helpful and pure Swift implemented library for registering and reusing views in table view and collection view.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
                       ReusableProtocol is a helpful and pure Swift implemented library for registering and reusing views in table view and collection view.
                       DESC
